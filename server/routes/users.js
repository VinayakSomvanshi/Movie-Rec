...
sgMail.setApiKey("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")
    ...
    try {
        ...
        if (user) {
            ...
            const html =
                ...
                <body>
                    <center>
                        ...
                        <br/>
                        <a 
                            href="http://localhost:3000/confirmation/ResetPassword/Reset/${hashtoken}" 
                            style="
            ...
            const mailOptions = {
                from: {
                    name: "APSIT",
                    email: "yogeshkumbhar1503@gmail.com"},
                  to: sanitize(user.email),
                subject: 'APSIT 🎬 | Password Reset',
                html: html,
            }
